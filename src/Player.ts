...
export default class Player {
  ...
  /**
   * Test whether a password collides with the player
   *
   * @param item The password to test for
   * @returns true if the password has indeed collided
   */
  ...
  /**
   * Render the submarine to the canvas
   *
